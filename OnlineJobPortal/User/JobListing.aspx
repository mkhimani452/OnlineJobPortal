                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4">
                        ...
                        <div class="job-category-listing mb-50">
                            ...
                            <div class="single-listing">
                               <div class="small-section-tittle2">
                                ...
                                <div class="select-job-items2">
                                   <asp:DropDownList ID="ddlCountry" runat="server" CssClass="form-control w-100" AppendDataBoundItems="True" DataSourceID="SqlDataSource1" DataTextField="CountryName" DataValueField="CountryName" OnSelectedIndexChanged="ddlCountry_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                ...
                                <div class="select-Categories pt-80 pb-50">
                                    ...
                                    <asp:CheckBoxList ID="CheckBoxList1" runat="server" AutoPostBack="True" CssClass="styled" OnSelectedIndexChanged="CheckBoxList1_SelectedIndexChanged" RepeatLayout="Flow">
                            ...
                            <div class="single-listing">
                                ...
                                <div class="select-Categories pb-50">
                                    ...
                                    <div class="radiobuttoncontainer">
                                        <asp:RadioButtonList ID="RadioButtonList1" runat="server" CssClass="radiobuttonlist" AutoPostBack="true" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged">
                            ...
                            <div class="mb-4">
                                <asp:LinkButton ID="lbReset" runat="server" CssClass="btn btn-sm" Width="100%" OnClick="lbReset_Click">Reset</asp:LinkButton>
                            </div>
                        </div>
